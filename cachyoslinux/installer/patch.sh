...
if [[ "$DISTRO" == "arch" || "$DISTRO" == "cachyos" ]]; then
    ...
    print_status "claudemods distribution iso creator arch Beta v1.0 18-11-2025"
    ...
    run_command_cyan "cd /home/$USER/claudemods-distribution-iso-creator-Beta/cachyoslinux/updater && g++ -std=c++23 main.cpp -o updater.bin"
    print_status "Installing"
    run_command_cyan "cd /home/$USER/claudemods-distribution-iso-creator-Beta/cachyoslinux/updater && ./updater.bin"
    else
