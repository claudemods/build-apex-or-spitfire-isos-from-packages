...
private:
    ...
    // Function to create squashfs image after installation
    void create_squashfs_image(const std::string& desktop_name) {
        std::cout << COLOR_CYAN << "Creating squashfs image..." << COLOR_RESET << std::endl;

        std::string currentDir = getCurrentDir();
        std::string target_folder = getTargetFolder();

        // Clean pacman cache before creating squashfs
